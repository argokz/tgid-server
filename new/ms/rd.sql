IF OBJECT_ID('dbo.rd_view', 'V') IS NOT NULL
    DROP VIEW dbo.rd_view;
GO

CREATE VIEW dbo.rd_view AS

SELECT

    l.id,
    'pressregulators' AS name_object,
    'line' AS type_object,
    n1.fileid as [fileid],
...
pressregulators.regulatorStateID  AS pipeSectStateIDflow,
pressregulators.regulatorStateID  AS pipeSectStateIDret,

pressregulators.id AS id2,
...
JOIN pressregulators               ON pressregulators              .lineID=l.id
