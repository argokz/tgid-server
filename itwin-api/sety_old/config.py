...
# Тут нужно смотреть что за параметры
    ...
    parser.add_argument('-iter', required=False, type=int, default=20, dest='', help=argparse.SUPPRESS)
    parser.add_argument('-tp_metod', required=False, type=int, default=1, dest='', help=argparse.SUPPRESS)
    parser.add_argument('-type_of_net', required=False, type=int, default=1, dest='', help=argparse.SUPPRESS)
    parser.add_argument('-time', required=False, type=str, default='', dest='', help=argparse.SUPPRESS)
