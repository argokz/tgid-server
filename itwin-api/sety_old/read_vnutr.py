...
#                    if po1%2 == 1:
                    if G_gvop != 0:
                        ...
                        G.add_edge((id1, po1), (_ATMOSPHERE, 1), key=(id, 5), po=1, Y=1, **ut, state=1)
                    ...
                    if G_gvoo != 0:
                        ...
                        _ATMOSPHERE = add_atm(G)
                        G.add_edge((id1, po1), (_ATMOSPHERE, 1), key=(id, 6), po=1, Y=1, **ut, state=1)
...
#                        print('==========', t)
                        ...
                        if t == 43:
                            ...
                            if G_rez == 0:
                                print(f'Не задана нагрузка рециркуляции для [{get_pt_name(nP)}]', color='red')
                                exit(0)
                            if a11 == 0:
                                print(f'Не задана потеря напора в открытой ГВ [{get_pt_name(nP)}]', color='red')
                                exit(0)
